...
def format_data_row(row):
    """
    Extracts data from a single HTML table row and formats it into two lines
    matching the target TXT format based on the provided example.
    """
    cells = row.find_all('td', class_=['RWReport', 'RWReportSUM'])
    ...
    line2_parts = []
    # Indices for the second line: HTML[4], HTML[6]...HTML[18]
